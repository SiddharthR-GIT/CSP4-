...
public class TicTacToeClient extends JFrame implements Runnable{
    ...
    public static void main( String args[] ) {
        ...
        application.execute(); // this is the server must be started started in tread
        // set up as background tread in swing utility's
